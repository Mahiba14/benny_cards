...
@section('main-content')
  ...
  <div class="card shadow mb-4">
    ...
    <div class="table-responsive">
      ...
      data-target="#viewModal{{$category->id}}" style="height:30px; width:30px;border-radius:50%"
      title="View">
      ...
      <div class="modal-content">
        ...
        <p><strong>Is Parent:</strong> {{ $category->is_parent == 1 ? 'Yes' : 'No' }}</p>
        <p><strong>Parent Category:</strong> {{ $category->parent_info->title ?? 'N/A' }}</p>
      ...
      @endif
        ...
        @if($category->photo)
      <img src="{{asset($category->photo) }}" class="img-fluid" style="max-width:150px"
      alt="{{ $category->title }}">
      @else
